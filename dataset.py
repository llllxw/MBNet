...
# 修改路径以符合新的工作环境
sys.path.append('/home/MBNet/data')

# %%

class TestbedDataset(InMemoryDataset):
    def __init__(self, root='/home/MBNet/data', dataset='set', xds=None, xmixfp=None, xbert=None, y=None, smile_graph=None, compound_index_dict=None, compound_smile_dict=None, transform=None, pre_transform=None):
